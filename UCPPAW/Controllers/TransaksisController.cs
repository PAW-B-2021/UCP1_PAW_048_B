...
namespace UCPPAW.Controllers
{
    public class TransaksisController : Controller
    {
        ...
        public TransaksisController(JualBajuContext context)
        {
            _context = context;
        }
        ...
        {
            var jualBajuContext = _context.Transaksis.Include(t => t.IdBarangNavigation).Include(t => t.IdCustomerNavigation);
        ...
        public async Task<IActionResult> Create([Bind("IdTransaksi,IdBarang,IdCustomer,Tanggal")] Transaksi transaksi)
        {
            ...
            ViewData["IdBarang"] = new SelectList(_context.Barangs, "IdBarang", "IdBarang", transaksi.IdBarang);
